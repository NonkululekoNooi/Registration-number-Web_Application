...
describe("Error messages", function () {
    it("should return an error message if registration number is not entered", function () {
      ...
      let message = regNo.errorMessages(" ");
...
describe("should return the registration number that are stored in an empty array",function(){
  it("should return the registration number from Cape Town in stored an array", function(){
    const regNo = myReg()
    let message = regNo.addingReg('CA 8582')

    assert.deepEqual(['CA 8582'],regNo.getRegistration())
  })
